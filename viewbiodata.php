...
<div class="w3-top">
  <div class="w3-bar w3-yellow w3-wide w3-padding w3-card">
    <a href="#home" class="w3-bar-item w3-button">Daftar Biodata</a>
  ...
  <div class="w3-container w3-padding-32" id="contact">
    ...
    ?>
        <tr>
          ...
          <td><a href="javascript:void(0)" class="w3-button w3-tiny w3-red" onClick="deleteid(<?php echo $row['id'];?>,window.location.href)">Hapus</button></td>
        </tr>
