...
<div class="w3-top">
  <div class="w3-bar w3-yellow w3-wide w3-padding w3-card">
    <a href="#home" class="w3-bar-item w3-button">Halaman Utama</a>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="contact">
    ...
    <div class="w3-row">
      ...
      <a href="addbiodata.php" class="w3-button w3-border w3-xxxlarge w3-green">Input Biodata</a>
      </div>
      <div class="w3-col w3-container w3-center m4">
      <a href="viewbiodata.php" class="w3-button w3-border w3-xxxlarge w3-green">Hapus Biodata</a>    
      </div>
      <div class="w3-col w3-container w3-center m4 "> 
      <a href="profilbiodata.php" class="w3-button w3-border w3-xxxlarge w3-green">View Biodata</a>
      </div>
      </div>
      <!-- <div class="w3-col w3-container w3-center m4 "> 
      <a href="updatebiodata.php" class="w3-button w3-border w3-xxxlarge w3-purple">update</a>
      </div> -->
    </div> 
