...
<div class="w3-top">
  <div class="w3-bar w3-yellow w3-wide w3-padding w3-card">
    <a href="#home" class="w3-bar-item w3-button">Profil</a>
  ...
  <div class="w3-container w3-padding-32" id="contact">
    ...
    ?>
        <tr>
          ...
          <td>
            <a class="w3-button w3-tiny w3-orange" href="updatebiodata.php?id=<?php echo $row['id']; ?>">update</a>
          </td>
        </tr>
...
<!-- Footer -->
<footer class="w3-bottom w3-center w3-black w3-padding-7">
